<?php /* Smarty version 2.6.31, created on 2021-08-06 05:30:37
         compiled from cache/themes/SuiteP/modules/stud_student/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 108, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 157, false),array('function', 'multienum_to_array', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 1405, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 101, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 586, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 586, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 586, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/stud_student/DetailView.tpl', 597, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='stud_student'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='stud_student'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='stud_student'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='stud_student'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'stud_student'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'stud_student'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'stud_student'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS','module' => 'stud_student'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS','module' => 'stud_student'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php if (! $this->_tpl_vars['fields']['lawful_basis']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['lawful_basis']['value'] ) && ( $this->_tpl_vars['fields']['lawful_basis']['value'] != '^^' )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lawful_basis']['value']; ?>
">
<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['lawful_basis']['value'],'assign' => 'vals'), $this);?>

<?php $_from = $this->_tpl_vars['vals']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
<li style="margin-left:10px;"><?php echo $this->_tpl_vars['fields']['lawful_basis']['options'][$this->_tpl_vars['item']]; ?>
</li>
...
<?php if (! $this->_tpl_vars['fields']['lawful_basis_source']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['lawful_basis_source']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['lawful_basis_source']['options'][$this->_tpl_vars['fields']['lawful_basis_source']['value']]; ?>
...
<?php if (! $this->_tpl_vars['fields']['date_reviewed']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['date_reviewed']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_reviewed']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_reviewed']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['date_reviewed']['name']; ?>
